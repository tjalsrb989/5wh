...
public class RouteSelect extends AppCompatActivity implements MapView.MapViewEventListener,  MapView.OpenAPIKeyAuthenticationResultListener, View.OnClickListener, MapView.CurrentLocationEventListener {
    ...
    private void initView() {
        ...
        mSearchEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Toast.makeText(getApplicationContext(), "검색리스트에서 장소를 선택해주세요", Toast.LENGTH_SHORT, Toast.INFO, true).show();
            }
        });
    }
